...
numerical_feature1 = 'AgeMonths'
categorical_feature1 = 'Vaccinated'
categorical_feature2 = 'Size'
...
schedule_columns = ['dimension_1', 'dimension_2', 'imp_1', 'imp_2', 'imp_3', 'od_1', 'imp_col_1', 'imp_col_2','imp_col_3', 'quality', 'algorithm']
...
def sample_schedule():
    ...
    ods = list(itertools.combinations(od_techniques, 1))
    # %%
    ...
    schedule_tot.columns = ['0_z', '0_x', '1_x', '2_x', '0_y', '1_y', '2_y']
    schedule_tot_dim = dim.merge(schedule_tot, how='cross')
    schedule_tot_dim.columns = ['0_k', '1_k', '0_z', '0_x', '1_x', '2_x', '0_y', '1_y', '2_y']
    schedule_tot_perc = schedule_tot_dim.merge(quality, how='cross')
    schedule_tot_perc.columns = ['dimension_1', 'dimension_2', 'od_1', 'imp_1', 'imp_2', 'imp_3',
                                 'imp_col_1', 'imp_col_2',
                                 'imp_col_3', 'quality']
    sample = schedule_tot_perc[['dimension_1', 'dimension_2', 'imp_1', 'imp_2', 'imp_3', 'od_1',
                                 'imp_col_1', 'imp_col_2',
                                 'imp_col_3', 'quality']]
    ...
    df5 = sample[((sample.imp_col_1 == categorical_feature1) | (sample.imp_col_1 == categorical_feature1)) & (sample.imp_1.isin(imputation_techniques_num))]
    df6 = sample[((sample.imp_col_2 == categorical_feature1) | (sample.imp_col_2 == categorical_feature1)) & (sample.imp_2.isin(imputation_techniques_num))]
    df7 = sample[((sample.imp_col_3 == categorical_feature1) | (sample.imp_col_3 == categorical_feature1)) & (sample.imp_3.isin(imputation_techniques_num))]

    df8 = sample[((sample.imp_col_1 == categorical_feature2) | (sample.imp_col_1 == categorical_feature2)) & (sample.imp_1.isin(imputation_techniques_num))]
    df9 = sample[((sample.imp_col_2 == categorical_feature2) | (sample.imp_col_2 == categorical_feature2)) & (sample.imp_2.isin(imputation_techniques_num))]
    df10 = sample[((sample.imp_col_3 == categorical_feature2) | (sample.imp_col_3 == categorical_feature2)) & (sample.imp_3.isin(imputation_techniques_num))]

    for d in [df1, df2, df3, df5, df6, df7, df8, df9, df10]:
...
def suggested_schedule(df, perc_q, perc_nan, perc_out):
    ...
    final_schedule.columns = ['imp_col_1', 'imp_col_2', 'imp_col_3', 'algorithm', 'imp_1', 'imp_2', 'imp_3', 'od_1',
