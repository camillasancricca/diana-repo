...
numerical_feature1 = 'CustomerAge'
numerical_feature2 = 'CustomerSatisfaction'
categorical_feature1 = 'CustomerGender'
...
def suggest_completeness_cat(test, m):
    ...
    for technique in techniques_completeness_cat:
        model = pickle.load(open('models/CR_cat_' + technique + '_' + m, 'rb'))
        y_pred = model.predict(test)
        results.append([technique, y_pred])
