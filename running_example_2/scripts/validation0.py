...
def validate_sample(df, sample, algorithm, name_class):
    ...
    if sample.dimension_1 == 'completeness':
        ...
        df_clean, df_performance_1, df_performance_2 = improve_accuracy(df_clean, sample.od_2, sample.od_5, sample.od_7, sample.imp_1, sample.imp_2, sample.imp_3, sample.imp_4, sample.imp_5, sample.imp_6, sample.imp_7, sample.imp_col_1, sample.imp_col_2, sample.imp_col_3, sample.imp_col_4, sample.imp_col_5, sample.imp_col_6, sample.imp_col_7, algorithm, name_class)
    else:
        df_clean, df_performance, df_performance_2 = improve_accuracy(df_clean, sample.od_2, sample.od_5, sample.od_7, sample.imp_1, sample.imp_2, sample.imp_3, sample.imp_4, sample.imp_5, sample.imp_6, sample.imp_7, sample.imp_col_1, sample.imp_col_2, sample.imp_col_3, sample.imp_col_4, sample.imp_col_5, sample.imp_col_6, sample.imp_col_7, algorithm, name_class)
...
if __name__ == '__main__':
    ...
    sample_schedule = sample_schedule[0:20000]
    ...
    sample_schedule.to_csv('schedule/compiled_sample_schedule0.csv', index=False)
