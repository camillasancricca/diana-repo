...
schedule_columns = ['dimension_1', 'dimension_2', 'imp_1', 'imp_2', 'imp_3', 'od_1', 'od_2', 'od_3', 'imp_col_1', 'imp_col_2','imp_col_3', 'quality', 'algorithm']
...
def sample_schedule():
    ...
    schedule_tot_perc.columns = ['dimension_1', 'dimension_2', 'od_1', 'od_2', 'od_3', 'imp_1', 'imp_2', 'imp_3',
                                 'imp_col_1', 'imp_col_2',
                                 'imp_col_3', 'quality']
    sample = schedule_tot_perc[['dimension_1', 'dimension_2', 'imp_1', 'imp_2', 'imp_3', 'od_1', 'od_2', 'od_3',
                                 'imp_col_1', 'imp_col_2',
                                 'imp_col_3', 'quality']]
...
def suggested_schedule(df, perc_q, perc_nan, perc_out):
    ...
    order_algoritm_imputation_and_out[['od_1', 'od_2', 'od_3']] = str(None)
    ...
    final_schedule.columns = ['imp_col_1', 'imp_col_2', 'imp_col_3', 'algorithm', 'imp_1', 'imp_2', 'imp_3', 'od_1',
                              'od_2', 'od_3', 'dimension_1', 'dimension_2', 'keep']
