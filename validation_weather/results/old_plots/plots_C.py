...
if __name__ == '__main__':
    ...
    plt.plot(perc_quality, get_median(completeness_first[['quality', algorithm+'_2']], algorithm+'_2'), label='completeness first')
    plt.scatter(completeness_first.quality, completeness_first[algorithm+'_2'], label='completeness first', s=10)
    ...
    plt.scatter(sample_completeness.quality, sample_completeness[algorithm+'_dirty'], label='dirty', s=10, color='orange')
    ...
    plt.plot(perc_quality, get_median(sample_completeness[['quality', algorithm+'_2']], algorithm+'_2'), label='accuracy first')
    plt.plot(perc_quality, get_median(sample_completeness[['quality', algorithm+'_dirty']], algorithm+'_dirty'), label='dirty')
    plt.scatter(sample_completeness.quality, sample_completeness[algorithm+'_2'], label='accuracy first', s=10)
    plt.scatter(sample_completeness.quality, sample_completeness[algorithm+'_dirty'], label='dirty', s=10)
    plt.plot(perc_quality, get_median(suggested_completeness[['quality', 'perf_2']], 'perf_2'), label='suggested', color='red')
    plt.scatter(suggested_completeness.quality, suggested_completeness.perf_2, label='suggested', s=10, color='red')
    ...
    plt.plot(perc_quality, get_median(completeness_first[['quality', algorithm+'_1']], algorithm+'_1'), label='accuracy')
    plt.plot(perc_quality, get_median(completeness_first[['quality', algorithm+'_2']], algorithm+'_2'), label='completeness')
    plt.plot(perc_quality, get_median(sample_completeness[['quality', algorithm+'_dirty']], algorithm+'_dirty'), label='dirty')
    plt.scatter(completeness_first.quality, completeness_first[algorithm+'_1'], label='accuracy', s=10)
    plt.scatter(completeness_first.quality, completeness_first[algorithm+'_2'], label='completeness', s=10)
    plt.scatter(sample_completeness.quality, sample_completeness[algorithm+'_dirty'], label='dirty', s=10)
    ...
    plt.plot(perc_quality, get_median(sample_accuracy[['quality', algorithm+'_2']], algorithm+'_2'), label='accuracy')
    plt.plot(perc_quality, get_median(sample_accuracy[['quality', algorithm+'_1']], algorithm+'_1'), label='completeness')
    plt.plot(perc_quality, get_median(sample_accuracy[['quality', algorithm+'_dirty']], algorithm+'_dirty'), label='dirty')
    plt.scatter(sample_accuracy.quality, sample_accuracy[algorithm+'_2'], label='accuracy', s=10)
    plt.scatter(sample_accuracy.quality, sample_accuracy[algorithm+'_1'], label='completeness', s=10)
    ...
    temp_suggested = pd.DataFrame(suggested_completeness[['dimension_1', 'quality', 'perf_dirty', 'perf_1', 'perf_2']])
    ...
    all_completeness = all[all.dimension_1 == 'completeness']

    sns.set_theme(style="ticks", palette="deep")
    sns.displot(all_completeness[all_completeness.suggested == 'NO'], x=algorithm+"_1", kde=True)
    plt.title(algorithm+' all schedules first dimension (only completeness -> accuracy)')
    plt.xlim(lim)
    plt.savefig("/Users/camillasancricca/Desktop/" + str(i) + '_' + algorithm + ".pdf", bbox_inches='tight')
    i += 1

    sns.displot(all_completeness[all_completeness.suggested == 'YES'], x=algorithm+"_1", kde=True)
    plt.xlim(lim)
    plt.title(algorithm+' suggested schedule first dimension (only completeness -> accuracy)')
    plt.savefig("/Users/camillasancricca/Desktop/" + str(i) + '_' + algorithm + ".pdf", bbox_inches='tight')
    i += 1

    ### differenza distribuzioni tra suggested e tutte le altre combinaizoni
    sns.set_theme(style="ticks", palette="deep")
    sns.displot(all_completeness[all_completeness.suggested == 'NO'], x=algorithm+"_2", kde=True)
    plt.title(algorithm+' all schedules (only completeness -> accuracy)')
    plt.xlim(lim)
    plt.savefig("/Users/camillasancricca/Desktop/" + str(i) + '_' + algorithm + ".pdf", bbox_inches='tight')
    i += 1

    sns.displot(all_completeness[all_completeness.suggested == 'YES'], x=algorithm+"_2", kde=True)
    plt.xlim(lim)
    plt.title(algorithm+' suggested schedule (only completeness -> accuracy)')
    plt.savefig("/Users/camillasancricca/Desktop/" + str(i) + '_' + algorithm + ".pdf", bbox_inches='tight')
    i += 1
