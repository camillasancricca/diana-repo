...
def sample_schedule():
    ...
    imp = list(itertools.combinations(imputation_techniques, 7))
    ...
    sample = schedule_tot_dim[['dimension_1', 'dimension_2', 'imp_1', 'imp_2', 'imp_3','imp_4', 'imp_5', 'imp_6','imp_7',
                               'od_1', 'od_2', 'od_3', 'od_4', 'od_5', 'od_6', 'od_7',
                               'imp_col_1', 'imp_col_2', 'imp_col_3', 'imp_col_4', 'imp_col_5', 'imp_col_6', 'imp_col_7']]
